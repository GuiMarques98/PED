...
begin
    G0 : E0_Modo port map (MODO_MUX => saidaMUX(0), ENTER => Enter, MODO_CHAVE => Chave(0), MODO_OUT => Modo);
    G1 : MaquinaEstados port map (Enter=>enter,modo=>modo,saida=>saidaEstado);
    G2 : MUX3x7 port map (ProcessoSaida=>saidaMUX,Processo=>saidaEstado);
